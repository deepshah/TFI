                                        ...
                                        <div class="art-post-inner art-article">
                                          ...
                                          String dtt="";
                                                            ...
                                                            <form  action="stats2.jsp">
                                                                ...
                                                                <input type="text" value="<%out.print(request.getParameter("theDate"));%>" readonly name="theDate"></input>
                                                        ...
                                                        <%
                                                            try {
                                                                ...
                                                                String q = "select count(*) from attendance where cid = '" + c_id + "'" + "  and studentstatus='P' and dateid='" + request.getParameter("theDate") + "'";
                                                ...
                                                <%
                                                try {
                                                    out.print(request.getParameter("theDate"));
                                                        ServletContext cont = config.getServletContext();
                                                        String url = cont.getInitParameter("url");
                                                        String username = cont.getInitParameter("username");
                                                        String password = cont.getInitParameter("password");
                                                        ...
                                                        String query = "select * from attendance where dateid='"+request.getParameter("theDate")+"' and cid='"+request.getParameter("cid") +"'";
